...
# CLAVE GEMINI (LEER DESDE SECRETS/ENV VAR)
...
# 1. Configuración de Usuarios (La contraseña '12345' encriptada con bcrypt)
names = ['Admin Logistica', 'Repartidor Juan']
usernames = ['admin', 'juan']
# Contraseñas encriptadas (Ejemplo, usa contraseñas fuertes)
hashed_passwords = ['$2b$12$A8.T.Q.z.H.tQp.S/Y.xU.P/G.wR.l.F.k.m.H.p.T.a.B.i.X/C.z.H.w', 
                    '$2b$12$B8.U.R.a.H.tQp.S/Y.xU.P/G.wR.l.F.k.m.H.p.T.a.B.i.X/C.z.H.x'] 

authenticator = stauth.Authenticate(
    names,
    usernames,
    hashed_passwords,
    'chivofast_dashboard_cookie',
    'Chivofast_secret_key_123', # Clave secreta para la cookie (¡DEBE SER ÚNICA!)
